...
insert into cidade (id, nome, estado_id) values (2, 'Belo Horizonte', 4);
insert into cidade (id, nome, estado_id) values (3, 'São Paulo', 2);
insert into cidade (id, nome, estado_id) values (4, 'Campinas', 2);
insert into cidade (id, nome, estado_id) values (5, 'Fortaleza', 3);

insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, ativo, aberto, endereco_cidade_id, endereco_cep, endereco_logradouro, endereco_numero, endereco_bairro) values (1, 'Java Gourmet', 10, 1, utc_timestamp, utc_timestamp, true, true, 1, '38400-999', 'Rua João Pinheiro', '1000', 'Centro');
...
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, ativo, aberto) values (6, 'Bar do José', 6, 4, utc_timestamp, utc_timestamp, true, true);
...
insert into produto (nome, descricao, preco, ativo, restaurante_id) values ('Not Chickenzito', 'Delicioso empanado', 78.90, 0, 1);
insert into produto (nome, descricao, preco, ativo, restaurante_id) values ('NotBurguer', 'Delicioso hamburger', 110, 1, 1);
insert into produto (nome, descricao, preco, ativo, restaurante_id) values ('Salada picante com not chicken grelhado', 'Salada de folhas com cortes finos de not chicken grelhado e nosso molho especial de pimenta vermelha', 87.20, 1, 2);
insert into produto (nome, descricao, preco, ativo, restaurante_id) values ('Garlic Naan', 'Pão tradicional indiano com cobertura de alho', 21, 1, 3);
insert into produto (nome, descricao, preco, ativo, restaurante_id) values ('Murg Curry', 'Cubos de not chicken preparados com molho curry e especiarias', 43, 1, 3);
insert into produto (nome, descricao, preco, ativo, restaurante_id) values ('NotBurger', 'Corte macio e suculento, com dois dedos de espessura', 79, 1, 4);
insert into produto (nome, descricao, preco, ativo, restaurante_id) values ('NotBurger', 'Corte muito saboroso', 89, 1, 4);
...
values (1, 'f9981ca4-5a5e-4da3-af04-933861df3e55', 1, 6, 1, 1, '00000-000', 'Rua Dos Testes', '000', 'Apto 000', 'Brasil',
...
insert into pedido (id, codigo, restaurante_id, usuario_cliente_id, forma_pagamento_id, endereco_cidade_id, endereco_cep,
                    endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro,
                    status, data_criacao, subtotal, taxa_frete, valor_total)
values (2, 'd178b637-a785-4768-a3cb-aa1ce5a8cdab', 4, 6, 2, 1, '00000-000', 'Rua Dos Testes', '000', 'Atp 000', 'Brasil',
...
insert into pedido (id, codigo, restaurante_id, usuario_cliente_id, forma_pagamento_id, endereco_cidade_id, endereco_cep,
                    endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro,
                    status, data_criacao, data_confirmacao, data_entrega, subtotal, taxa_frete, valor_total)
values (4, '5c621c9a-ba61-4454-8631-8aabefe58dc2', 1, 6, 1, 1, '00000-000', 'Rua Dos Testes', '000', 'Apto 000', 'Brasil',
...
insert into pedido (id, codigo, restaurante_id, usuario_cliente_id, forma_pagamento_id, endereco_cidade_id, endereco_cep,
                    endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro,
                    status, data_criacao, data_confirmacao, data_entrega, subtotal, taxa_frete, valor_total)
values (5, '8d774bcf-b238-42f3-aef1-5fb388754d63', 1, 6, 2, 1, '00000-000', 'Rua Dos Testes', '000', 'Apt 000', 'Brasil',
...
values ('moserfood-web', null, '$2y$12$w3igMjsfS5XoAYuowoH3C.54vRFWlcXSHLjX7MwF990Kc2KKKh72e',
        'READ,WRITE', 'password,authorization_code', 'http://localhost:8081,http://localhost:8081/swagger-ui/oauth2-redirect.html', null,
...
insert into oauth_client_details (client_id, resource_ids, client_secret,
                                  scope, authorized_grant_types, web_server_redirect_uri, authorities,
                                  access_token_validity, refresh_token_validity, autoapprove)
values ('faturamento', null, '$2y$12$fHixriC7yXX/i1/CmpnGH.RFyK/l5YapLCFOEbIktONjE8ZDykSnu',
