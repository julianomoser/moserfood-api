...
values (3, 'Ceará');
insert into estado (id, nome)
values (4, 'Minas Gerais');

insert into cidade (id, nome, estado_id)
values (1, 'Curitiba', 1);
insert into cidade (id, nome, estado_id)
values (2, 'Belo Horizonte', 4);
insert into cidade (id, nome, estado_id)
...
values (1, 'Java Gourmet', 10, 1, utc_timestamp, utc_timestamp, true, true, 1, '38400-999', 'Rua João Pinheiro', '1000',
        'Centro');
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, ativo, aberto)
...
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, ativo, aberto)
values (6, 'Bar do José', 6, 4, utc_timestamp, utc_timestamp, true, true);
...
values ('Not Chickenzito', 'Delicioso empanado', 78.90, 0, 1);
insert into produto (nome, descricao, preco, ativo, restaurante_id)
values ('NotBurguer', 'Delicioso hamburger', 110, 1, 1);
insert into produto (nome, descricao, preco, ativo, restaurante_id)
values ('Salada picante com not chicken grelhado',
        'Salada de folhas com cortes finos de not chicken grelhado e nosso molho especial de pimenta vermelha', 87.20,
        1, 2);
insert into produto (nome, descricao, preco, ativo, restaurante_id)
values ('Garlic Naan', 'Pão tradicional indiano com cobertura de alho', 21, 1, 3);
insert into produto (nome, descricao, preco, ativo, restaurante_id)
values ('Murg Curry', 'Cubos de not chicken preparados com molho curry e especiarias', 43, 1, 3);
insert into produto (nome, descricao, preco, ativo, restaurante_id)
values ('NotBurger', 'Corte macio e suculento, com dois dedos de espessura', 79, 1, 4);
insert into produto (nome, descricao, preco, ativo, restaurante_id)
values ('NotBurger', 'Corte muito saboroso', 89, 1, 4);
insert into produto (nome, descricao, preco, ativo, restaurante_id)
values ('Sanduíche X-Tudo', 'Sandubão com muito queijo, not hamburger, ovo, salada e maionese', 19, 1, 5);
insert into produto (nome, descricao, preco, ativo, restaurante_id)
values ('Espetinho de NotChicken', 'Acompanha farinha, mandioca e vinagrete', 8, 1, 6);
...
values (1, 'João da Silva', 'joao.ger@moserfood.com', '$2a$12$t8tCTVkIkie7oCb6mjBzuewep.We2dskHEQc3tfivKuqLIDdQ8FW2',
        utc_timestamp),
       (2, 'Mario Joaquin', 'mario.vnd@moserfood.com', '$2a$12$t8tCTVkIkie7oCb6mjBzuewep.We2dskHEQc3tfivKuqLIDdQ8FW2',
        utc_timestamp),
       (3, 'José Souza', 'jose.aux@moserfood.com', '$2a$12$t8tCTVkIkie7oCb6mjBzuewep.We2dskHEQc3tfivKuqLIDdQ8FW2',
        utc_timestamp),
       (4, 'Sebastião Martins', 'sebastiao.cad@moserfood.com',
        '$2a$12$t8tCTVkIkie7oCb6mjBzuewep.We2dskHEQc3tfivKuqLIDdQ8FW2', utc_timestamp),
       (5, 'Manoel Lima', 'manoel.loja@gmail.com', '$2a$12$t8tCTVkIkie7oCb6mjBzuewep.We2dskHEQc3tfivKuqLIDdQ8FW2',
        utc_timestamp),
       (6, 'Juliano Moser', 'juliano.moserjj@gmail.com', '$2a$12$NmMDqVVog.q6L/iTpJoklu.y6xU/QAt0P0FENlnRW2qdAL05MA5Om',
        utc_timestamp),
       (7, 'Carlos Moser', 'carlos.test@gmail.com', '$2a$12$t8tCTVkIkie7oCb6mjBzuewep.We2dskHEQc3tfivKuqLIDdQ8FW2',
        utc_timestamp);
...
values (1, 'f9981ca4-5a5e-4da3-af04-933861df3e55', 1, 6, 1, 1, '00000-000', 'Rua Dos Testes', '000', 'Apto 000',
        'Brasil',
...
insert into pedido (id, codigo, restaurante_id, usuario_cliente_id, forma_pagamento_id, endereco_cidade_id,
                    ...
                    endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro,
                    status, data_criacao, subtotal, taxa_frete, valor_total)
values (2, 'd178b637-a785-4768-a3cb-aa1ce5a8cdab', 4, 6, 2, 1, '00000-000', 'Rua Dos Testes', '000', 'Atp 000',
        'Brasil',
        'CRIADO', utc_timestamp, 79, 0, 79);

insert into item_pedido (id, pedido_id, produto_id, quantidade, preco_unitario, preco_total, observacao)
values (3, 2, 6, 1, 79, 79, 'Com queijo');

insert into pedido (id, codigo, restaurante_id, usuario_cliente_id, forma_pagamento_id, endereco_cidade_id,
                    endereco_cep,
                    endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro,
                    status, data_criacao, data_confirmacao, data_entrega, subtotal, taxa_frete, valor_total)
values (3, 'b5741512-8fbc-47fa-9ac1-b530354fc0ff', 1, 6, 1, 1, '00000-000', 'Rua Dos Testes', '000', null, 'Brasil',
...
insert into pedido (id, codigo, restaurante_id, usuario_cliente_id, forma_pagamento_id, endereco_cidade_id,
                    ...
                    endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro,
                    status, data_criacao, data_confirmacao, data_entrega, subtotal, taxa_frete, valor_total)
values (4, '5c621c9a-ba61-4454-8631-8aabefe58dc2', 1, 6, 1, 1, '00000-000', 'Rua Dos Testes', '000', 'Apto 000',
        'Brasil',
...
insert into pedido (id, codigo, restaurante_id, usuario_cliente_id, forma_pagamento_id, endereco_cidade_id,
                    ...
                    endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro,
                    status, data_criacao, data_confirmacao, data_entrega, subtotal, taxa_frete, valor_total)
values (5, '8d774bcf-b238-42f3-aef1-5fb388754d63', 1, 6, 2, 1, '00000-000', 'Rua Dos Testes', '000', 'Apt 000',
        'Brasil',
...
VALUES('1', 'moserfood-backend', '2022-11-29 18:58:12', '$2a$10$trk401po.Wx9JXXMs2xCFeB.eXU7qENFquETcr04a0hDJxGV3ge0.', NULL, 'MoserFood Backend', 'client_secret_basic', 'client_credentials', '', 'READ', '{"@class":"java.util.Collections$UnmodifiableMap","settings.client.require-proof-key":false,"settings.client.require-authorization-consent":false}', '{"@class":"java.util.Collections$UnmodifiableMap","settings.token.reuse-refresh-tokens":true,"settings.token.id-token-signature-algorithm":["org.springframework.security.oauth2.jose.jws.SignatureAlgorithm","RS256"],"settings.token.access-token-time-to-live":["java.time.Duration",1800.000000000],"settings.token.access-token-format":{"@class":"org.springframework.security.oauth2.server.authorization.settings.OAuth2TokenFormat","value":"self-contained"},"settings.token.refresh-token-time-to-live":["java.time.Duration",3600.000000000],"settings.token.authorization-code-time-to-live":["java.time.Duration",300.000000000]}');

INSERT INTO oauth2_registered_client
(id, client_id, client_id_issued_at, client_secret, client_secret_expires_at, client_name, client_authentication_methods, authorization_grant_types, redirect_uris, scopes, client_settings, token_settings)
VALUES('2', 'moserfood-web', '2022-11-29 18:58:12', '$2a$10$/Lx1cVKanXiCkpYtdA369OZ78x8aHwx51RTxC.4pqEiuZRzQh0e/i', NULL, 'MoserFood Web', 'client_secret_basic', 'refresh_token,authorization_code', 'http://127.0.0.1:8081/swagger-ui/oauth2-redirect.html,http://127.0.0.1:8081/authorized', 'READ,WRITE', '{"@class":"java.util.Collections$UnmodifiableMap","settings.client.require-proof-key":false,"settings.client.require-authorization-consent":true}', '{"@class":"java.util.Collections$UnmodifiableMap","settings.token.reuse-refresh-tokens":false,"settings.token.id-token-signature-algorithm":["org.springframework.security.oauth2.jose.jws.SignatureAlgorithm","RS256"],"settings.token.access-token-time-to-live":["java.time.Duration",900.000000000],"settings.token.access-token-format":{"@class":"org.springframework.security.oauth2.server.authorization.settings.OAuth2TokenFormat","value":"self-contained"},"settings.token.refresh-token-time-to-live":["java.time.Duration",86400.000000000],"settings.token.authorization-code-time-to-live":["java.time.Duration",300.000000000]}');
